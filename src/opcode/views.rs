...
use super::{AxisDirection, Handle, Id, Variable};
...
pub struct Button<'a> {
    /// Button label text.
    pub text: Variable<'a, Cow<'a, str>>,
    /// Click handle.
    pub click: Handle<'a>,
    /// Optional icon.
    pub icon: Option<Variable<'a, Cow<'a, str>>>,
}
...
pub struct TextField<'a> {
    ...
    pub prompt: Variable<'a, Cow<'a, str>>,
}
